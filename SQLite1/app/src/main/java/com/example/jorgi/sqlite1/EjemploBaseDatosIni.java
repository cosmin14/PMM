package com.example.jorgi.sqlite1;
...
public class EjemploBaseDatosIni extends ActionBarActivity {
            ...
            /*  String[] args2 = new String[]{"cli2"};
        		...
        		if (c.moveToFirst()) {
        			...
        			do {
						...
						Toast.makeText(EjemploBaseDatosIni.this, "Nombre: " + nombreCli + " - Telefono: " + telefonoCli, Toast.LENGTH_LONG).show();
					} while (c.moveToNext());
        		}
